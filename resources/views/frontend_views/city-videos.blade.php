...
@section('page_title','City Videos')
...
<div class="city-video-section">
    <div class="inner-city-video">
       <!--======= Search Header Area =======-->
       <div class="header-search-wrapper">
          <h1 class="page-heading">City Videos</h1>
       ...
       <div class="city-videos-list">
        @livewire('frontend.list-youtube-component', ['autoLocate'=>true])
       </div>
