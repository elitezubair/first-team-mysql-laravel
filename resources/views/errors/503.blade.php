...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Under Maintenance Page</title>
  <meta name="viewport" content="width=device-width, initial-scale=1">
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600&display=swap" rel="stylesheet"><link rel="stylesheet" href="./style.css">
...
<main>
  ...
  <h2>We are sorry for the inconvenience. In the meantime, please contact at <a href="mailto:{{env('MAIL_FROM_ADDRESS')}}">{{env('MAIL_FROM_ADDRESS')}}</a> for any questions.</h2>
</main>
<!-- partial -->
